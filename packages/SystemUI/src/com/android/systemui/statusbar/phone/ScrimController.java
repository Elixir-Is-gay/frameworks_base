...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener, Dumpable,
    ...
    private void updateScrimColor(View scrim, float alpha, int tint) {
        ...
        boolean isAutoDepthClock = customUtils.getAutomatedDepthClock(mScrimBehind.getContext().getContentResolver());
        if ((mState == ScrimState.KEYGUARD) && (isDepthClock || isAutoDepthClock)) {
            alpha = 0.0f;
        }

...
open class ClockRegistry(
    ...
    private val customClockChangeObserver =
        object : ContentObserver(null) {
            override fun onChange(
                selfChange: Boolean,
                uris: Collection<Uri>,
    ...
    fun registerListeners() {
        ...
        context.contentResolver.registerContentObserver(
            Settings.Secure.getUriFor(Settings.Secure.LOCKSCREEN_DEPTH_CLOCK_AUTO_REFRESH ),
            /*notifyForDescendants=*/ false,
            customClockChangeObserver
        )
    ...
    fun unregisterListeners() {
        ...
        context.contentResolver.unregisterContentObserver(customClockChangeObserver)
    ...
    fun createCurrentClock(): ClockController {
        ...
        val isUpdaterInstalled = customUtils.isPackageInstalled(context, "com.elixer.updater", false)
        val isExclusiveEnabled = customUtils.getExclusive(context.contentResolver)
        ...
        if (((isForceCustomClock) && (isUpdaterInstalled) && (isExclusiveEnabled))) {
